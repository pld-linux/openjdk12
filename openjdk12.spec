...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk12-jdk < 12.0.2-3
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk12-jdk-base < 12.0.2-3
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk12-jre < 12.0.2-3
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk12-jre-base < 12.0.2-3
...
Obsoletes:	openjdk12-jre-base-X11 < 12.0.2-3
...
Obsoletes:	openjdk12-jre-base-freetype < 12.0.2-3
...
Obsoletes:	jar
Obsoletes:	openjdk12-jar < 12.0.2-3
